...
//     // ✅ CRITICAL FIX: CascadeType.ALL + orphanRemoval
//     @OneToMany(
//         mappedBy = "buyer", 
...
// File: src/main/java/com/itti/leadcapturing/model/Buyer.java
...
public class Buyer {
    ...
    // ✅ NEW: Link to Organization Admin who created this buyer
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "created_by_org_admin_id")
    private OrganizationAdmin createdByOrgAdmin;

    // ✅ NEW: Store the organization's company name for hierarchy lookup
