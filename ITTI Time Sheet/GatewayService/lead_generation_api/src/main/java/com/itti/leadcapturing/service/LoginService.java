...
// //             // ✅ STEP 2: Find User
// //             log.info("🔍 STEP 2: Searching for user in database...");
...
// //             log.info("   Encoded password from DB: {}...", user.getPassword().substring(0, Math.min(20, user.getPassword().length())));
...
// //             // ✅ STEP 6: Fetch Related Data (with NULL safety)
// //             log.info("📦 STEP 6: Fetching related data...");
...
// //                         // Get buyer from location
// //                         buyer = location.getBuyer();
// //                         if (buyer != null) {
// //                             log.info("   ✅ Buyer: {} (ID: {})", buyer.getCompanyName(), buyer.getId());
// //                         }
// //                     }
// //                 }
                
// //                 // Fallback: Get buyer directly from user if not found via location
// //                 if (buyer == null && user.getBuyer() != null) {
// //                     buyer = user.getBuyer();
// //                     log.info("   ✅ Buyer (from user): {} (ID: {})", buyer.getCompanyName(), buyer.getId());
// //                 }
                
// //             } catch (Exception e) {
// //                 log.warn("   ⚠️  Error fetching related data (non-critical): {}", e.getMessage());
// //             }
...
// //             } catch (Exception e) {
// //                 log.warn("   ⚠️  Failed to update last login: {}", e.getMessage());
// //             }
...
// //             e.printStackTrace();
// //             response.setSuccess(false);
// //             response.setMessage("Database error: Missing required data");
// //             return response;
...
//     /**
//      * ✅ CRITICAL FIX: Added @Transactional to prevent LazyInitializationException
//      */
...
//             // ✅ STEP 6: Fetch Related Data INSIDE TRANSACTION (Critical Fix)
//             log.info("📦 STEP 6: Fetching related data (inside transaction)...");
//             Department department = null;
//             Location location = null;
//             Buyer buyer = null;
            
//             try {
//                 // ✅ CRITICAL: Access lazy-loaded relationships INSIDE transaction
//                 if (user.getDepartment() != null) {
//                     department = user.getDepartment();
//                     // Force initialization by accessing properties
//                     department.getId();
//                     department.getDepartmentName();
//                     log.info("   ✅ Department loaded: {} (ID: {})", 
...
//                     location.getId();
//                     location.getLocationName();
//                     log.info("   ✅ Location loaded (from user): {} (ID: {})", 
//                              location.getLocationName(), location.getId());
...
//                         buyer.getId();
//                         buyer.getCompanyName();
//                         log.info("   ✅ Buyer loaded (from location): {} (ID: {})", 
//                                  buyer.getCompanyName(), buyer.getId());
//                     }
//                 }
...
//                     buyer.getId();
//                     buyer.getCompanyName();
//                     log.info("   ✅ Buyer loaded (from user): {} (ID: {})", 
//                              buyer.getCompanyName(), buyer.getId());
//                 }
...
//                 e.printStackTrace();
//                 // Don't fail login if related data can't be loaded
//                 log.warn("   ⚠️  Continuing without complete related data");
//             }
...
//                 } catch (Exception e) {
//                     log.warn("   ⚠️  Could not add department details: {}", e.getMessage());
//                 }
//             }
...
//                 } catch (Exception e) {
//                     log.warn("   ⚠️  Could not add location details: {}", e.getMessage());
//                 }
//             }
...
//                 } catch (Exception e) {
//                     log.warn("   ⚠️  Could not add buyer details: {}", e.getMessage());
//                 }
//             }
            
//             // ✅ Update last login timestamp (in separate transaction to avoid issues)
//             try {
...
//     /**
//      * ✅ Separate method to update last login in new transaction
//      */
//     @Transactional
