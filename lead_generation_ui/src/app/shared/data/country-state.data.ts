...
// // Shared data: all world countries + states/provinces
// // Used by both buyer and supplier creation forms
// // ============================================================

// export interface CountryData {
//   name: string;
//   code: string;          // ISO 3166-1 alpha-2
//   states: string[];      // provinces / states / regions
// }

// export const COUNTRY_STATE_DATA: CountryData[] = [
//   {
//     name: 'Afghanistan', code: 'AF',
//     states: ['Badakhshan','Badghis','Baghlan','Balkh','Bamiyan','Daykundi','Farah','Faryab',
...
//     states: ['Buenos Aires','Catamarca','Chaco','Chubut','Córdoba','Corrientes',
...
//     states: ['Aragatsotn','Ararat','Armavir','Gegharkunik','Kotayk','Lori','Shirak',
...
//     states: ['Burgenland','Carinthia','Lower Austria','Salzburg','Styria','Tyrol',
//       'Upper Austria','Vienna','Vorarlberg']
//   },
//   {
//     name: 'Azerbaijan', code: 'AZ',
//     states: ['Absheron','Agdam','Agdash','Aghjabadi','Agstafa','Agsu','Astara',
//       'Baku','Balakan','Barda','Beylagan','Bilasuvar','Dashkasan','Fuzuli',
//       'Gadabay','Ganja','Gobustan','Goranboy','Goychay','Goygol','Hajigabul',
//       'Imishli','Ismailli','Jabrayil','Jalilabad','Kalbajar','Kurdamir','Lachin',
//       'Lankaran','Lerik','Masally','Mingachevir','Nakhchivan','Neftchala',
//       'Oghuz','Qakh','Qazakh','Quba','Qubadli','Qus','Saatly','Sabirabad',
//       'Salyan','Shamakhi','Shamkir','Shirvan','Shusha','Siyazan','Sumgayit',
//       'Tartar','Tovuz','Ujar','Yardymli','Yevlakh','Zangilan','Zaqatala','Zardab']
//   },
//   {
...
//     states: ['Barisal','Chittagong','Dhaka','Khulna','Mymensingh','Rajshahi',
//       'Rangpur','Sylhet']
//   },
//   {
//     name: 'Belgium', code: 'BE',
//     states: ['Antwerp','Brussels','East Flanders','Flemish Brabant','Hainaut',
//       'Liège','Limburg','Luxembourg','Namur','Walloon Brabant','West Flanders']
//   },
//   {
//     name: 'Bolivia', code: 'BO',
//     states: ['Beni','Chuquisaca','Cochabamba','La Paz','Oruro','Pando','Potosí',
//       'Santa Cruz','Tarija']
//   },
//   {
//     name: 'Brazil', code: 'BR',
...
//   {
//     name: 'Chile', code: 'CL',
//     states: ['Antofagasta','Araucanía','Arica y Parinacota','Atacama','Aysén',
//       'Biobío','Coquimbo','Los Lagos','Los Ríos','Magallanes','Maule',
//       'Metropolitana de Santiago','Ñuble','O\'Higgins','Tarapacá','Valparaíso']
//   },
//   {
//     name: 'China', code: 'CN',
//     states: ['Anhui','Beijing','Chongqing','Fujian','Gansu','Guangdong','Guangxi',
...
//     states: ['Amazonas','Antioquia','Arauca','Atlántico','Bolívar','Boyacá',
...
//     states: ['Bjelovar-Bilogora','Brod-Posavina','Dubrovnik-Neretva','Istria',
...
//       'Virovitica-Podravina','Vukovar-Srijem','Zadar','Zagreb','Zagreb City']
//   },
//   {
//     name: 'Czech Republic', code: 'CZ',
//     states: ['Central Bohemia','Hradec Králové','Karlovy Vary','Liberec','Moravia-Silesia',
//       'Olomouc','Pardubice','Plzeň','Prague','South Bohemia','South Moravia',
//       'Ústí nad Labem','Vysočina','Zlín']
//   },
//   {
//     name: 'Denmark', code: 'DK',
//     states: ['Capital Region','Central Denmark','North Denmark','Region Zealand',
//       'Southern Denmark']
//   },
//   {
//     name: 'Egypt', code: 'EG',
//     states: ['Alexandria','Aswan','Asyut','Beheira','Beni Suef','Cairo','Dakahlia',
...
//     states: ['Addis Ababa','Afar','Amhara','Benishangul-Gumuz','Dire Dawa',
//       'Gambela','Harari','Oromia','Sidama','Somalia','South Ethiopia',
//       'Southern Nations Nationalities and Peoples','Tigray']
//   },
//   {
//     name: 'Finland', code: 'FI',
//     states: ['Central Finland','Central Ostrobothnia','Kainuu','Kymenlaakso',
...
//       'South Savo','Southwest Finland','Tavastia Proper','Uusimaa']
//   },
//   {
//     name: 'France', code: 'FR',
//     states: ['Auvergne-Rhône-Alpes','Bourgogne-Franche-Comté','Bretagne','Centre-Val de Loire',
...
//     states: ['Baden-Württemberg','Bavaria','Berlin','Brandenburg','Bremen','Hamburg',
...
//       'North East','Northern','Oti','Savannah','Upper East','Upper West','Volta','Western',
//       'Western North']
//   },
//   {
//     name: 'Greece', code: 'GR',
//     states: ['Attica','Central Greece','Central Macedonia','Crete','Eastern Macedonia and Thrace',
//       'Epirus','Ionian Islands','North Aegean','Peloponnese','South Aegean',
//       'Thessaly','Western Greece','Western Macedonia']
//   },
//   {
//     name: 'Hungary', code: 'HU',
//     states: ['Baranya','Bács-Kiskun','Békés','Borsod-Abaúj-Zemplén','Budapest',
...
//     states: ['Aceh','Bali','Bangka Belitung Islands','Banten','Bengkulu',
...
//       'Southeast Sulawesi','South Kalimantan','South Sulawesi','South Sumatra',
//       'West Java','West Kalimantan','West Nusa Tenggara','West Papua',
//       'West Sulawesi','West Sumatra','Yogyakarta']
//   },
//   {
//     name: 'Iran', code: 'IR',
//     states: ['Alborz','Ardabil','Bushehr','Chaharmahal and Bakhtiari','East Azerbaijan',
//       'Fars','Gilan','Golestan','Hamadan','Hormozgan','Ilam','Isfahan','Kerman',
//       'Kermanshah','Khuzestan','Kohgiluyeh and Boyer-Ahmad','Kurdistan',
...
//   {
//     name: 'Iraq', code: 'IQ',
//     states: ['Al Anbar','Al Muthanna','Al Qadisiyyah','An Najaf','Arbil','Babylon',
//       'Baghdad','Basra','Dhi Qar','Diyala','Dohuk','Karbala','Kirkuk',
//       'Maysan','Nineveh','Saladin','Sulaymaniyah','Wasit']
//   },
//   {
//     name: 'Ireland', code: 'IE',
//     states: ['Carlow','Cavan','Clare','Cork','Donegal','Dublin','Galway','Kerry',
...
//   {
//     name: 'Israel', code: 'IL',
//     states: ['Central District','Haifa District','Jerusalem District','Northern District',
//       'Southern District','Tel Aviv District']
//   },
//   {
//     name: 'Italy', code: 'IT',
//     states: ['Abruzzo','Aosta Valley','Apulia','Basilicata','Calabria','Campania',
...
//   {
//     name: 'Japan', code: 'JP',
//     states: ['Aichi','Akita','Aomori','Chiba','Ehime','Fukui','Fukuoka','Fukushima',
...
//   {
//     name: 'Jordan', code: 'JO',
//     states: ['Ajloun','Aqaba','Balqa','Irbid','Jarash','Karak','Ma\'an','Madaba',
//       'Mafraq','Tafilah','Zarqa','Amman']
//   },
//   {
//     name: 'Kazakhstan', code: 'KZ',
//     states: ['Abai','Akmola','Aktobe','Almaty','Almaty City','Astana','Atyrau',
//       'East Kazakhstan','Jetisu','Karaganda','Kostanay','Kyzylorda','Mangystau',
//       'North Kazakhstan','Pavlodar','Shymkent','Turkestan','West Kazakhstan','Zhambyl','Zhetisu']
//   },
//   {
//     name: 'Kenya', code: 'KE',
//     states: ['Baringo','Bomet','Bungoma','Busia','Elgeyo-Marakwet','Embu','Garissa',
...
//   {
//     name: 'Kuwait', code: 'KW',
//     states: ['Al Ahmadi','Al Farwaniyah','Al Jahra','Capital','Hawalli','Mubarak Al-Kabeer']
//   },
//   {
//     name: 'Malaysia', code: 'MY',
//     states: ['Johor','Kedah','Kelantan','Kuala Lumpur','Labuan','Malacca','Negeri Sembilan',
...
//     states: ['Béni Mellal-Khénifra','Casablanca-Settat','Daraa-Tafilalet',
//       'Drâa-Tafilalet','Fès-Meknès','Guelmim-Oued Noun','Laâyoune-Sakia El Hamra',
//       'Marrakech-Safi','Oriental','Rabat-Salé-Kénitra','Souss-Massa','Tanger-Tetouan-Al Hoceima']
//   },
//   {
//     name: 'Myanmar', code: 'MM',
//     states: ['Ayeyarwady','Bago','Chin','Kachin','Kayah','Kayin','Magway',
//       'Mandalay','Mon','Naypyidaw Union Territory','Rakhine','Sagaing','Shan','Tanintharyi','Yangon']
//   },
//   {
//     name: 'Nepal', code: 'NP',
...
//     states: ['Drenthe','Flevoland','Friesland','Gelderland','Groningen','Limburg',
//       'Noord-Brabant','Noord-Holland','Overijssel','Utrecht','Zeeland','Zuid-Holland']
//   },
//   {
//     name: 'New Zealand', code: 'NZ',
//     states: ['Auckland','Bay of Plenty','Canterbury','Gisborne','Hawke\'s Bay',
...
//   {
//     name: 'Norway', code: 'NO',
//     states: ['Agder','Innlandet','Møre og Romsdal','Nordland','Oslo','Rogaland',
//       'Troms og Finnmark','Trøndelag','Vestfold og Telemark','Vestland','Viken']
//   },
//   {
//     name: 'Oman', code: 'OM',
//     states: ['Ad Dakhiliyah','Al Buraimi','Al Wusta','Az Zahirah','Dhofar',
//       'Musandam','Muscat','North Al Batinah','North Ash Sharqiyah',
//       'South Al Batinah','South Ash Sharqiyah']
//   },
//   {
//     name: 'Pakistan', code: 'PK',
//     states: ['Azad Kashmir','Balochistan','Gilgit-Baltistan','Islamabad Capital Territory',
//       'Khyber Pakhtunkhwa','Punjab','Sindh']
//   },
//   {
//     name: 'Philippines', code: 'PH',
//     states: ['Abra','Agusan del Norte','Agusan del Sur','Aklan','Albay','Antique',
...
//   {
//     name: 'Poland', code: 'PL',
//     states: ['Greater Poland','Kuyavian-Pomeranian','Lesser Poland','Łódź','Lower Silesian',
...
//     states: ['Alentejo','Algarve','Azores','Beiras and Serra da Estrela','Centro',
//       'Lisbon','Madeira','Norte','West and Tagus Valley']
//   },
//   {
//     name: 'Qatar', code: 'QA',
//     states: ['Ad Dawhah','Al Khor','Al Rayyan','Al Shahaniya','Al Wakrah',
//       'Ash Shamal','Az Za\'ayin','Umm Salal']
//   },
//   {
//     name: 'Romania', code: 'RO',
//     states: ['Alba','Arad','Argeș','Bacău','Bihor','Bistrița-Năsăud','Botoșani',
...
//   {
//     name: 'Russia', code: 'RU',
//     states: ['Adygea','Altai Krai','Altai Republic','Amur Oblast','Arkhangelsk Oblast',
...
//       'Khanty-Mansiysk','Kirov Oblast','Komi','Kostroma Oblast',
//       'Krasnodar Krai','Krasnoyarsk Krai','Kurgan Oblast','Kursk Oblast',
//       'Leningrad Oblast','Lipetsk Oblast','Magadan Oblast','Mari El',
//       'Mordovia','Moscow','Moscow Oblast','Murmansk Oblast',
//       'Nenets Autonomous Okrug','Nizhny Novgorod Oblast','North Ossetia',
...
//       'Sakha','Sakhalin Oblast','Samara Oblast','Saratov Oblast',
...
//     states: ['Al Bahah','Al Jawf','Al Madinah','Al Qassim','Asir','Eastern Province',
//       'Ha\'il','Jizan','Mecca','Najran','Northern Borders','Riyadh','Tabuk']
//   },
//   {
...
//     states: ['Busan','Chungcheongbuk-do','Chungcheongnam-do','Daegu','Daejeon',
...
//     states: ['Central','Eastern','North Central','North Western','Northern',
//       'Sabaragamuwa','Southern','Uva','Western']
//   },
//   {
//     name: 'Sweden', code: 'SE',
//     states: ['Blekinge','Dalarna','Gävleborg','Gotland','Halland','Jämtland',
...
//     states: ['Aargau','Appenzell Ausserrhoden','Appenzell Innerrhoden','Basel-Landschaft',
...
//   {
//     name: 'Taiwan', code: 'TW',
//     states: ['Changhua','Chiayi City','Chiayi County','Hsinchu City','Hsinchu County',
//       'Hualien','Keelung','Kinmen','Lienchiang','Miaoli','Nantou','New Taipei',
...
//     states: ['Amnat Charoen','Ang Thong','Bangkok','Bueng Kan','Buri Ram','Chachoengsao',
...
//   {
//     name: 'Turkey', code: 'TR',
//     states: ['Adana','Adıyaman','Afyonkarahisar','Ağrı','Aksaray','Amasya','Ankara',
//       'Antalya','Ardahan','Artvin','Aydın','Balıkesir','Bartın','Batman','Bayburt',
//       'Bilecik','Bingöl','Bitlis','Bolu','Burdur','Bursa','Çanakkale','Çankırı',
//       'Çorum','Denizli','Diyarbakır','Düzce','Edirne','Elâzığ','Erzincan','Erzurum',
...
//       'Siirt','Sinop','Şırnak','Sivas','Tekirdağ','Tokat','Trabzon','Tunceli',
...
//     states: ['Cherkasy','Chernihiv','Chernivtsi','Crimea','Dnipropetrovsk','Donetsk',
//       'Ivano-Frankivsk','Kharkiv','Kherson','Khmelnytskyi','Kirovohrad','Kyiv',
//       'Kyiv City','Luhansk','Lviv','Mykolaiv','Odessa','Poltava','Rivne',
...
//     states: ['Bedfordshire','Berkshire','Bristol','Buckinghamshire','Cambridgeshire',
//       'Cheshire','City of London','Cornwall','Cumbria','Derbyshire','Devon','Dorset',
...
//     states: ['Andijan','Bukhara','Fergana','Jizzakh','Karakalpakstan','Kashkadarya',
//       'Khorezm','Namangan','Navoiy','Samarqand','Sirdaryo','Surxondaryo','Tashkent',
//       'Tashkent City']
//   },
//   {
//     name: 'Venezuela', code: 'VE',
//     states: ['Amazonas','Anzoátegui','Apure','Aragua','Barinas','Bolívar','Carabobo',
...
//     states: ['An Giang','Bà Rịa-Vũng Tàu','Bắc Giang','Bắc Kạn','Bạc Liêu',
...
//   {
//     name: 'Yemen', code: 'YE',
//     states: ['Abyan','Aden','Al Bayda','Al Hudaydah','Al Jawf','Al Mahrah',
//       'Al Mahwit','Amran','Dhamar','Hadramawt','Hajjah','Ibb','Lahij',
//       'Marib','Raymah','Saada','Sanaa','Saná\'a','Shabwah','Socotra','Taiz']
//   },
//   {
//     name: 'Zambia', code: 'ZM',
//     states: ['Central','Copperbelt','Eastern','Luapula','Lusaka','Muchinga',
//       'North-Western','Northern','Southern','Western']
//   },
//   {
//     name: 'Zimbabwe', code: 'ZW',
//     states: ['Bulawayo','Harare','Manicaland','Mashonaland Central','Mashonaland East',
//       'Mashonaland West','Masvingo','Matabeleland North','Matabeleland South','Midlands']
//   }
// ];

// // ✅ Helper: get states for a given country name
// export function getStatesForCountry(countryName: string): string[] {
//   if (!countryName || !countryName.trim()) return [];
//   const found = COUNTRY_STATE_DATA.find(
...
//   return COUNTRY_STATE_DATA.map(c => c.name);
// }


// ============================================================
// country-state-city.data.ts
// Comprehensive world data: countries → states → cities → postal codes
// Used by buyer/supplier creation forms for address auto-fill
// ============================================================
