...
public class RFQItem {
    ...
    // ✅ CRITICAL FIX: @JsonIgnore must be on BOTH field AND getter
    @JsonIgnore
    @OneToMany(mappedBy = "item", cascade = CascadeType.ALL, orphanRemoval = true, fetch = FetchType.LAZY)
    private List<RFQItemAttachment> attachments = new ArrayList<>();
    ...
    public Object getDynamicFieldValue(String fieldName) {
        return getDynamicFieldsAsMap().getOrDefault(fieldName, null);
    }
    ...
    public String getSummary() {
        return String.format(
            "RFQItem[id=%d, description=%s, quantity=%s, companyType=%s, hasDynamicFields=%b, attachments=%d]",
            this.id, this.itemDescription, this.quantity, this.companyType,
            this.dynamicFields != null && !this.dynamicFields.isEmpty(),
            this.attachments != null ? this.attachments.size() : 0
        );
    }
    ...
    public String getItemDescriptionDetailed() { return itemDescriptionDetailed; }
    public void setItemDescriptionDetailed(String itemDescriptionDetailed) { this.itemDescriptionDetailed = itemDescriptionDetailed; }
    ...
    // ✅ CRITICAL FIX: @JsonIgnore on the GETTER - this is what actually stops Jackson
    @JsonIgnore
    public List<RFQItemAttachment> getAttachments() {
    ...
    public void setAttachments(List<RFQItemAttachment> attachments) {
