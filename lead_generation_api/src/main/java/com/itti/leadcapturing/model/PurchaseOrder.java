...
//  * Professional PO like reference documents
//  */
// @Entity
...
//     private String poNumber; // e.g., ITTI/PO/26/067
...
//     private Location buyerLocation; // Invoice To location
    
//     @ManyToOne(fetch = FetchType.EAGER)
//     @JoinColumn(name = "delivery_location_id", nullable = false)
//     @JsonIgnoreProperties({"departments", "hibernateLazyInitializer", "handler"})
//     private Location deliveryLocation; // Ship To location (Consignee)
